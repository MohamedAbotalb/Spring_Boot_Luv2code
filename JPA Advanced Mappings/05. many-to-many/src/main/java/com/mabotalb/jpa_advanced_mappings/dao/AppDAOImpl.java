...
public class AppDAOImpl implements AppDAO {
    ...
    public Course findCourseWithReviewsByCourseId(Integer id) {
        ...
        TypedQuery<Course> query = this.entityManager.createQuery(
                "SELECT c FROM Course c " +
                        "JOIN FETCH c.review WHERE c.id = :data", Course.class);
    ...
    @Override
    public Course findCourseWithStudentsByCourseId(Integer id) {
    ...
    @Override
    public Student findStudentWithCoursesByStudentId(Integer id) {
